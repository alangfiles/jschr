...
Object.assign(Mapper.prototype, {
  ...
  getMirroringType: function() {
    return this.rom.header.isHorizontalMirroring() === true
      ? this.rom.MIRRORINGS.HORIZONTAL
      : this.rom.MIRRORINGS.VERTICAL;
  }
});
...
MMC1Mapper.prototype = Object.assign(Object.create(Mapper.prototype), {
  ...
  mapForChrRom: function(address) {
    ...
    if (this.controlRegister.loadBit(4) === 0) {
      ...
      bank =
        (address < 0x1000
          ? this.chrBank0Register.load()
          : this.chrBank1Register.load()) & 0x1f;
    }
  ...
  store: function(address, value) {
    if (value & 0x80) {
      ...
      if ((address & 0x6000) === 0) this.controlRegister.storeBits(2, 2, 3);
    } else {
...
MMC3Mapper.prototype = Object.assign(Object.create(Mapper.prototype), {
  ...
  map: function(address) {
    ...
    if (address >= 0x8000 && address < 0xa000) {
      bank =
        this.register0.isBitSet(6) === true
          ? this.prgBankNum * 2 - 2
          : this.programRegister0.load();
   ...
   */
  getMirroringType: function() {
    return this.register2.isBitSet(0) === true
      ? this.rom.MIRRORINGS.HORIZONTAL
      : this.rom.MIRRORINGS.VERTICAL;
  },
